...
| In Progress | человек или оркестратор | человек просит работу (первый раз, правка) или релиз (фраза «релизь» и т.п.); оркестратор/воркер/релизер исполняет |
| Review | оркестратор | PR прошёл ревьюера (pass/blocked) или ревьюер исчерпал правки. Замечания — в issue, карточку верни в In Progress. Ок — «релизь» + In Progress |
