...
Ты исполняешь **один кусок плана** Goal оркестратора (один репо → один PR). Tool calls идут на VPS (Cursor My Machines). Не ходи в другие репо семьи, не трогай `cursor-cloud-agents`.
